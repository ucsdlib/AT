...
public class ImportOptionsAccessions extends JPanel implements ImportOptions{

	public static final boolean SUPPRESS_DATE_FORMAT = true;

	public ImportOptionsAccessions() {
		initComponents();
		initComboBoxes();
		setRepository(ApplicationFrame.getInstance().getCurrentUser().getRepository());
	}

	public ImportOptionsAccessions(boolean suppressDateFormats) {
		initComponents();
		initComboBoxes();
		setRepository(ApplicationFrame.getInstance().getCurrentUser().getRepository());
	...
	private void initComponents() {
		...
		resourceRecordCreationSelector = ATBasicComponentFactory.createUnboundComboBox(DelimitedAccessionImportHandler.getResourceRecordCreationValues());
	...
	private JLabel resourceRecordCreationLabel;
	private JComboBox resourceRecordCreationSelector;
	...
	public String getResourceRecordCreation() {
		return (String)resourceRecordCreationSelector.getSelectedItem();
	}
