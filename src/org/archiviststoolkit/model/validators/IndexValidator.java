...
public class IndexValidator extends ATAbstractValidator {
	 ...
	 */
	public IndexValidator(Accessions accession) {
	...
	public ValidationResult validate() {
		...
		Index modelToValidate = (Index)objectToValidate;

		ATPropertyValidationSupport support =
				new ATPropertyValidationSupport(modelToValidate, "Index");

		if (modelToValidate.getIndexItems().size() == 0)
			support.addError("At least one index item", "is mandatory");
