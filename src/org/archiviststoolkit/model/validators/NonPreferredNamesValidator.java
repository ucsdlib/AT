...
public class NonPreferredNamesValidator extends ATAbstractValidator {
	public NonPreferredNamesValidator() {
	}
	...
	public ValidationResult validate() {
		...
		NonPreferredNames modelToValidate = (NonPreferredNames)objectToValidate;
		ATPropertyValidationSupport support =
				new ATPropertyValidationSupport(modelToValidate, "Non preferred names");
