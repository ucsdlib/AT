...
public class IndexItemsValidator extends ATAbstractValidator {
	 ...
	 */
	public IndexItemsValidator(Accessions accession) {
		this.objectToValidate = accession;
	}

	public IndexItemsValidator() {
	}
	...
	public ValidationResult validate() {
		...
		IndexItems modelToValidate = (IndexItems)objectToValidate;

		ATPropertyValidationSupport support =
				new ATPropertyValidationSupport(modelToValidate, "Index Items");

		if (ValidationUtils.isBlank(modelToValidate.getItemType()))
			support.addError("Type", "is mandatory");
