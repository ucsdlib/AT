...
public class FileVersionsValidator extends ATAbstractValidator {
	
	public FileVersionsValidator() {
	}
	...
	public ValidationResult validate() {
		...
		FileVersions modelToValidate = (FileVersions)objectToValidate;
		ATPropertyValidationSupport support =
				new ATPropertyValidationSupport(modelToValidate, "File Versions");

		//URI is manditory
		if (ValidationUtils.isBlank(modelToValidate.getUri()))
			support.addError("URI", "is mandatory");

		//Use Statement is manditory
		if (ValidationUtils.isBlank(modelToValidate.getUseStatement()))
			support.addError("Use Statement", "is mandatory");
