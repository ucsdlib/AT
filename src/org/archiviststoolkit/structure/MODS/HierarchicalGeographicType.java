...
public class HierarchicalGeographicType {
    ...
    protected List<JAXBElement<String>> continentOrCountryOrProvince;
     ...
     * 
     */
    public List<JAXBElement<String>> getContinentOrCountryOrProvince() {
        if (continentOrCountryOrProvince == null) {
            continentOrCountryOrProvince = new ArrayList<JAXBElement<String>>();
        }
