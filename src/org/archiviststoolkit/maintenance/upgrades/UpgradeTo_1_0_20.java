...
public class UpgradeTo_1_0_20 extends Upgrade {
    ...
    protected boolean doUpgrade(Connection conn, int initialStep, int numberOfSteps, DeferredWizardResult.ResultProgressHandle progress) {
        ...
        try {
			...
			sqlString = "ALTER TABLE Accessions CHANGE processingPlan processingPlan text";
    ...
    protected boolean upgradeNeeded(Connection conn) throws SQLException {
        return Constants.compareVersions("1.0.20", DatabaseConnectionUtils.getDatabaseVersionInfo(conn)) == Constants.VERSION_GREATER;
    }
}
